...
<div id="change_banner">
  <div class="bigbanner_pic1"><img src="images/sj.jpg" width="1024" height="363"></div>
</div>
<!--div class="search"></div-->
<div class="content">
  <ul class="sj_c_u">
    <li><img src="images/BD.png" width="88" height="81" alt="duo"><br>
      <strong>指标精确</strong><br>
      <br>
      300多个统计指标<br>
      集中式汽车行业分析解决方案<br>
    </li>
    <li><img src="images/shuju.png" width="88" height="81" alt="快"><br>
      <strong>数据海量</strong><br>
      <br>
      千万级车辆数据资源<br>
      与省级官方交通互联网平台同步更新<br>
    </li>
    <li class="noborder"><img src="images/kehu.png" width="88" height="81" alt="好"><br>
      <strong>客户更多</strong><br>
      <br>
超过200家行业客户<br>
      使用本数据分析指导业务</li>
