...
<div id="change_banner_b">
  <div class="bigbanner_help">
    ...
    <div class="tile"><strong>找回密码</strong></div>
  </div>
</div>
...
<div class="grxx_right">
  <p><strong>找回密码步骤如下：</strong></p>
  <p>1)   在登录页面，点击“忘记登录密码”； </p>
  <p><img src="images/pic.png" width="616" height="269" alt="denglu"></p>
  <p>2)   进入确认账号信息页，填写要找回的用户，输入验证码，点击“下一步”；</p>
  <p><img src="images/pic.png" width="616" height="269" alt="denglu"></p>
  <p>3)   进入安全验证页， 选择找回密码的验证方式， 目前只能使用手机号找回密码；按提示完成验证，点击“下一步”； </p>
  <p><img src="images/pic.png" width="616" height="269" alt="denglu"></p>
  <p>4)   系统将会发送验证短信，验证通过后，进入重置密码页面，设置您的新密码后； </p>
  <p><img src="images/pic.png" width="616" height="269" alt="denglu"></p>
  <p>5)   设置成功后，回到登录页面，重新登录即可。 </p>
  <p><img src="images/pic.png" width="616" height="269" alt="denglu"></p>
</div>
