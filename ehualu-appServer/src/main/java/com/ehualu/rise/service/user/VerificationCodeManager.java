...
public class VerificationCodeManager implements ServiceInterface{
	...
	public Map<String, Object> handle(String head, String body) {
		...
		record.setContent(sms_msg);
		record.setFlag(usr.getFlag());
//		String result = smsService.sendSmsEmay(record);
//		if(!AppConstant.SMS_SEND_SUCCESS.equals(result)){
//			//验证码发送失败
//			header.setZtm(AppConstant.Code_01.AUTHENCODE_SEND_ERROR);
//			return formatResult(header, null);
//		}
