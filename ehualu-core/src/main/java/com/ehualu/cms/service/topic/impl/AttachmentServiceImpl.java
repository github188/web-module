...
import com.ehualu.cms.dao.topic.AttachmentDao;
import com.ehualu.cms.pojo.admin.Attachment;
import com.ehualu.cms.service.topic.AttachmentService;
import com.ehualu.rise.constants.AttachmentConstants;
...
public class AttachmentServiceImpl implements AttachmentService {
	...
	public static void deleteAttachFiles(Attachment a) {
		String realPath1 = SystemContext.getRealPath();
		realPath1 += AttachmentConstants.UPLOADPATH;
		new File(realPath1+a.getNewName()).delete();
		String realPath2 = SystemContext.getRealPath();
		realPath2 += AttachmentConstants.THUMBNAIL;
		new File(realPath2+a.getNewName()).delete();
	}
