package com.ehualu.cms.service.job.impl;
...
import com.ehualu.cms.dao.job.JobDao;
...
public class JobServiceImpl implements JobService {
	...
	public void add(Job job) {
		...
		job.setCreatetime(DateUtil.date2Str(new Date()));
		job.setLastupdatetime(DateUtil.date2Str(new Date()));
