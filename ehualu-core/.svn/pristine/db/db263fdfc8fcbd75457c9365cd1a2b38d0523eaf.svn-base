...
public class DrivingLicense implements Serializable {
	...
	private Date syrq;//下一审验日期
	private Date cclzrq;//初次领证日期
	private Date yxqs;//有效期始
	private Date yxqz;//有效期止
	private double ljjf;//累积记分
	...
	public DrivingLicense(String dabh, String sfzmhm, String zjcx, Date syrq,
			Date cclzrq, Date yxqs, Date yxqz, double ljjf, String zt,
			String xzqh, String fzjg, Date gxsj, String zxbh, String sfzmmc,
			String hmcd, String xm, String xb, Date csrq, String gj,
			String djzsxzqh, String djzsxxdz, String lxzsxzqh, String lxzsxxdz,
			String lxzsyzbm, String lxdh, String sjhm, String dzyx, String zzzm) {
		super();
		this.dabh = dabh;
		this.sfzmhm = sfzmhm;
		this.zjcx = zjcx;
