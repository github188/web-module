...
/**
 * 
 * @author Administrator 车辆违法表
 */
public class VehicleViolate implements Serializable{
	/**
	 * 
	 */
	...
	private String tzsh = "";
	//证据图片url列表
	private List<String> zjtp = new ArrayList<String>();

	//查询数量
	private int num;
	public VehicleViolate(String xh, String jdslb, String lxfs, String hpzl,
			String jdcsyr, String hphm, String fdjh, String wfdd, String wfdz,
			Date wfsj, String wfbh, String wfxw, String xzqh, String dsr,
			String fzjg, String dh, Date clsj, double fkje, String jdsbh,
			double wfjfs, String cjjg, String clbj, String clsbdh) {
		super();
		this.xh = xh;
		this.jdslb = jdslb;
		this.lxfs = lxfs;
	...
	public List<String> getZjtp() {
		return zjtp;
	}

	public void setZjtp(List<String> zjtp) {
		this.zjtp = zjtp;
	}
}
