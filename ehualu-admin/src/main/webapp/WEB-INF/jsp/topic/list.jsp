						...
						<div class="col-xs-12">
							<table id="sample-table-1" class="table table-striped table-bordered table-hover">
								...
								<c:forEach items="${datas.datas }" var="t">
									<tr>
										<td>
											<a href="javascript:openWin('<%=request.getContextPath() %>/news/show/${t.id }','showTopic')" class="list_link">${t.title }</a>
										</td>
										<td>${t.author}</td>
										<td class="hidden-480">
										...
										<td>
											<a class="btn btn-xs btn-info" href="update/${t.id }" title="编辑">
